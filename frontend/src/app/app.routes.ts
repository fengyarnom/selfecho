...
export const routes: Routes = [
  ...
  { path: 'category/:name', component: ArchiveComponent },
  { path: 'memos', component: MemoListComponent },
  { path: 'categories', component: CategoriesComponent },
  { path: 'login', component: LoginComponent },
  { path: 'admin', redirectTo: 'admin/posts', pathMatch: 'full' },
  { path: 'admin/posts', component: AdminComponent, canActivate: [authGuard], data: { fixedType: 'post' } },
  { path: 'admin/memos', component: AdminComponent, canActivate: [authGuard], data: { fixedType: 'memo' } },
